...
TypeMatchup = {
    'Bug'      : {'+attack'  : ['Grass', 'Psychic', 'Dark'],
                  '-attack'  : ['Fire', 'Fighting', 'Poison', 'Flying', 'Ghost', 'Steel', 'Fairy'],
                  '+defense' : ['Grass', 'Fighting', 'Ground'],
                  '-defense' : ['Fire', 'Flying', 'Rock']},
    'Dark'     : {'+attack'  : ['Psychic', 'Ghost'],
                  '-attack'  : ['Fighting', 'Dark', 'Fairy'],
                  '+defense' : ['Psychic', 'Ghost', 'Dark'],
                  '-defense' : ['Fighting', 'Bug', 'Fairy']},
    'Dragon'   : {'+attack'  : ['Dragon'],
                  '-attack'  : ['Steel', 'Fairy'],
                  '+defense' : ['Fire', 'Water', 'Electric', 'Grass'],
                  '-defense' : ['Ice', 'Dragon', 'Fairy']},
    'Electric' : {'+attack'  : ['Water', 'Flying'],
                  '-attack'  : ['Electric', 'Grass', 'Dragon', 'Ground'],
                  '+defense' : ['Electric', 'Flying', 'Steel'],
                  '-defense' : ['Ground']},
    'Fairy'    : {'+attack'  : ['Fighting', 'Dragon', 'Dark'],
                  '-attack'  : ['Fire', 'Poison', 'Steel'],
                  '+defense' : ['Dragon', 'Fighting', 'Bug', 'Dark'],
                  '-defense' : ['Poison', 'Steel']},
    'Fighting' : {'+attack'  : ['Normal', 'Ice', 'Rock', 'Dark', 'Steel'],
                  '-attack'  : ['Poison', 'Flying', 'Psychic', 'Bug', 'Fairy', 'Ghost'],
                  '+defense' : ['Bug', 'Rock', 'Dark'],
                  '-defense' : ['Flying', 'Psychic', 'Fairy']},
    'Fire'     : {'+attack'  : ['Grass', 'Ice', 'Bug', 'Steel'],
                  '-attack'  : ['Fire', 'Water', 'Rock', 'Dragon'],
                  '+defense' : ['Fire', 'Grass', 'Ice', 'Bug', 'Steel', 'Fairy'],
                  '-defense' : ['Water', 'Ground', 'Rock']},
    'Flying'   : {'+attack'  : ['Grass', 'Fighting', 'Bug'],
                  '-attack'  : ['Electric', 'Rock', 'Steel'],
                  '+defense' : ['Ground', 'Grass', 'Fighting', 'Bug'],
                  '-defense' : ['Electric', 'Ice', 'Rock']},
    'Ghost'    : {'+attack'  : ['Psychic', 'Ghost'],
                  '-attack'  : ['Dark', 'Normal'],
                  '+defense' : ['Normal', 'Fighting', 'Poison', 'Bug'],
                  '-defense' : ['Ghost', 'Dark']},
    'Grass'    : {'+attack'  : ['Water', 'Ground', 'Rock'],
                  '-attack'  : ['Fire', 'Grass', 'Poison', 'Flying', 'Bug', 'Dragon', 'Steel'],
                  '+defense' : ['Water', 'Electric', 'Grass', 'Ground'],
                  '-defense' : ['Fire', 'Ice', 'Poison', 'Flying', 'Bug']},
    'Ground'   : {'+attack'  : ['Fire', 'Electric', 'Poison', 'Rock', 'Steel'],
                  '-attack'  : ['Grass', 'Bug', 'Flying'],
                  '+defense' : ['Electric', 'Poison', 'Rock'],
                  '-defense' : ['Water', 'Grass', 'Ice']},
    'Ice'      : {'+attack'  : ['Grass', 'Ground', 'Flying', 'Dragon'],
                  '-attack'  : ['Fire', 'Water', 'Ice', 'Steel'],
                  '+defense' : ['Ice'],
                  '-defense' : ['Fire', 'Fighting', 'Rock', 'Steel']},
    'Normal'   : {'+attack'  : [],
                  '-attack'  : ['Rock', 'Steel', 'Ghost'],
                  '+defense' : ['Ghost'],
                  '-defense' : ['Fighting']},
    'Poison'   : {'+attack'  : ['Grass', 'Fairy'],
                  '-attack'  : ['Poison', 'Ground', 'Rock', 'Ghost', 'Steel'],
                  '+defense' : ['Grass', 'Fighting', 'Poison', 'Bug', 'Fairy'],
                  '-defense' : ['Ground', 'Psychic']},
    'Psychic'  : {'+attack'  : ['Fighting', 'Poison'],
                  '-attack'  : ['Psychic', 'Steel', 'Dark'],
                  '+defense' : ['Fighting', 'Psychic'],
                  '-defense' : ['Bug', 'Ghost', 'Dark']},
    'Rock'     : {'+attack'  : ['Fire', 'Ice', 'Flying', 'Bug'],
                  '-attack'  : ['Fighting', 'Ground', 'Steel'],
                  '+defense' : ['Normal', 'Fire', 'Poison', 'Flying'],
                  '-defense' : ['Water', 'Grass', 'Fighting', 'Ground', 'Steel']},
    'Steel'    : {'+attack'  : ['Ice', 'Rock', 'Fairy'],
                  '-attack'  : ['Fire', 'Water', 'Electric', 'Steel'],
                  '+defense' : ['Poison', 'Normal', 'Grass', 'Ice', 'Flying', 'Psychic', 'Bug', 'Rock', 'Dragon', 'Steel', 'Fairy'],
                  '-defense' : ['Fire', 'Fighting', 'Ground']},
    'Water'    : {'+attack'  : ['Fire', 'Ground', 'Rock'],
                  '-attack'  : ['Water', 'Grass', 'Dragon'],
                  '+defense' : ['Fire', 'Water', 'Ice', 'Steel'],
                  '-defense' : ['Electric', 'Grass']}}
